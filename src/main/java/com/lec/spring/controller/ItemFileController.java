...
public class ItemFileController {
    ...
    @Value("${app.item.upload.path}")  // org.springframework.beans.factory.annotation.Value
    private String uploadDir;

    private ItemFileService fileService;

    @Autowired
    public void setFileService(ItemFileService fileService) {
