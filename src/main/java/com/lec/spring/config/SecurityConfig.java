    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(auth -> auth   // AuthorizationManagerRequestMatcherRegistry
                        ...
                        .requestMatchers("/camping/reserve/**").authenticated()
                        .requestMatchers("/camping/recipts/**").hasAnyRole("MEMBER")
                        .requestMatchers("/lender/item/list/**").authenticated()
                        .requestMatchers("/lender/item/rent/**", "/lender/recipts/**").hasAnyRole("MEMBER")
                        .requestMatchers("/camping/admin/list/**", "/camping/admin/detail/**", "/camping/admin/write/**").hasAnyRole("CAMPING")
                        .requestMatchers("/camping/admin/update/**", "/camping/admin/campsiteList/**", "/camping/admin/campsiteWrite/**").hasAnyRole("CAMPING")
                        .requestMatchers("/camping/admin/campsiteDetail/**", "/camping/admin/campsiteUpdate/**").hasAnyRole("CAMPING")
                        ...
                        .requestMatchers("/admin/**", "/admin/city/list/**").hasAnyRole("ADMIN")
                        .requestMatchers("/coupon/write/**").authenticated()
                        .requestMatchers("/qna/myqna/**", "/qna/list/**").authenticated()
